...
namespace TcpMultiFileTransfer
{
    public partial class FrmMain : Form
    {
        ...
        private void btnWaitForFiles_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnSendFiles_Click_1(object sender, EventArgs e)
        {
        ...
        {
            txtIpAddress.Text = ipadresim;
            txtPortConnect.Text = portum + portum;
            txtPort.Text = txtPortConnect.Text;
